...
# AssistantName = "Jarvis"  # Make sure this line is executed before the next code
...
class ChatSelection(QWidget):
    ...
    def __init__(self):
        ...
        movie = QMovie(GraphicsDirectoryPath(r"Frontend\Graphics\Jarvis.gif"))
        max_gif_size_W = 480
        max_gif_size_H = 270
...
class InitialScreen(QWidget):
    def __init__(self, parent=None):
        ...
        pixmap = QPixmap(GraphicsDirectoryPath(r'Frontend\Graphics\Mic_on.png'))
    ...
    def load_iconss(self, path, width=60, height=60):
        pixmap = QPixmap(path)
        new_pixmap = pixmap.scaled(width, height)
        self.icon_label.setPixmap(new_pixmap)
    ...
    def toggle_icon(self, event=None):
        if self.toggled:
            self.load_iconss(GraphicsDirectoryPath(r'Frontend\Graphics\Mic_on.png'), 60, 60)
            MicButtonInitialed()
        
        else:
            self.load_icons(GraphicsDirectoryPath(r'Frontend\Graphics\Mic_off.png'), 60, 60)
            MicButtonClosed()
